  ...
  return (
    <div className='LatestArticles1'>
      <div className='latestarticlesleft'>
        ...
        { // eslint-disable-next-line
              Hollywood.map( (Fittdetails,index) =>{
                    if(index >=Hollywood.length-1 )
                    return (
                <div key={index} className='design'>
                  <div >
                 <Link to={`/Hollywood/${Fittdetails.id}`}><img className="images" src={Fittdetails.image} alt="" /></Link>
                  </div>
                  <div className='content-data'>
                <div >
...

{
...

          {
           ...
           <div className='design1'>
                <div >
                <Link to={`/Hollywood/${Fittdetails.id}`}><img className="images1" src={Fittdetails.image} alt="" /></Link>
                </div>
                <div className='content-data'>
              <div >
               <h3>{Fittdetails.name}</h3>
