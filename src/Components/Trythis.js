  ...
  return (
    <div>
       <div className="TryThiscomponent">
           ...
           <div>
              <button className='loading-buttons' onClick={Loadless}>Less <i class="btn btn-primary"></i></button>
           </div>
           </>
           :
           
           <div>
                <button className='loading-buttons' onClick={LoadMore}>More <i class="btn btn-primary"></i></button>
           </div>
           }
       </div>
    </div>
